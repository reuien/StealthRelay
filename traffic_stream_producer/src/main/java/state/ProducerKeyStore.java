...
public class ProducerKeyStore {
    ...
    private ProducerKeyStore(java.security.KeyStore ks, String path, char[] pwdArray) {
        this.keyStore = ks;
    ...
    public static ProducerKeyStore localKeystoreFromFile(String path, char[] pwdArray) throws IOException,
        ...
        return new ProducerKeyStore(ks, path, pwdArray);
    }

    public static ProducerKeyStore createLocalKeystore(String path, char[] pwdArray) throws KeyStoreException,
    ...
    public boolean syncKeystore(boolean force) throws QueryFailedException, CouldNotStoreException {
        if (path != null) {
    ...
    public String toString() {
        return "ProducerKeyStore{" +
                "keyStore=" + keyStore +
                ", path='" + path + '\'' +
                ", pwdArray=" + Arrays.toString(pwdArray) +
                ", dirty=" + dirty +
                ", keyCache=" + keyCache +
                '}';
    }
