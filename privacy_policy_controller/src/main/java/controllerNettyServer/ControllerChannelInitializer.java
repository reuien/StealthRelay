...
public class ControllerChannelInitializer extends ChannelInitializer<SocketChannel> {
    private ControllerRequestManager manager;
    private EventExecutorGroup dbHandlerPool;
    public ControllerChannelInitializer(ControllerRequestManager manager, EventExecutorGroup dbHandlerPool) {
    ...
    protected void initChannel(SocketChannel ch) throws Exception {
        ...
        p.addLast(dbHandlerPool, new ControllerRequestHandler(manager));
    }
}
