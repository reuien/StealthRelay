...
public class StreamCrypto {
    ...
    public Ciphertext encryptWithMAC(long msg, byte[] seedForID1, byte[] seedForID2, long metadataID) {
...
//        System.out.println("~~~");
    ...
    public long encrypt(long msg, byte[] seedForID1, byte[] seedForID2, long metadataID) {
        long digestDataCipher = enc.encrypt(msg,
                KeyUtil.deriveKey(kdt.getPRG(), seedForID1, true, metadataID),
                KeyUtil.deriveKey(kdt.getPRG(), seedForID2, true, metadataID));
...
//        long digestDataCipher = enc.encrypt(msg,
//                KeyUtil.deriveKey(PRGFactory.getDefaultPRG(), seedForID1, true, metadataID),
//                KeyUtil.deriveKey(PRGFactory.getDefaultPRG(), seedForID2, true, metadataID));
//        return digestDataCipher;
//    }
    ...
    public long decrypt(long msg, byte[] seedForID1, byte[] seedForID2, long metadataID) throws MACCheckFailed {
