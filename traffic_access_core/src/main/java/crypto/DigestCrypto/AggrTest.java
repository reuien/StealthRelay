...
public class AggrTest {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException {
        ...
        String csvFile = "traffic_access_core/src/main/java/crypto/DigestCrypto/Aggr_performance.csv";

        try (FileWriter writer = new FileWriter(csvFile)) {
            // 写入CSV文件的表头
            writer.append("iterations,encrypt,encryptWithKeyCanceling,keyAggr,keyAggrWithKeyCanceling,decrypt,decryptWithKeyCanceling\n");
            ...
            for (int currentIterations = step; currentIterations <= maxIterations; currentIterations += step) {
                ...
                for (int i = 0; i < currentIterations; i++) {
                    ...
                    long cipherWithKeyCanceling = encryptWithKeyCanceling(msg, key1, key2);
                ...
                for (int j = 0; j < currentIterations; j++) {
                    ...
                    long keyAggrTimeStart = System.nanoTime();
                    keyAggr += key;
                    long keyAggrTimeEnd = System.nanoTime();
                    keyAggrTime += (keyAggrTimeEnd - keyAggrTimeStart);
                }
                ...
                long keyAggrKCTimeStart = System.nanoTime();
                long keyAggrKC = key1 - key2;
                long keyAggrKCTimeEnd = System.nanoTime();
                keyAggrKCTime = keyAggrKCTimeEnd - keyAggrKCTimeStart;
                ...
                writer.append(Integer.toString(currentIterations)).append(",")
                        ...
                        .append(Long.toString(keyAggrTime/* / 1000000*/)).append(",") // 转换为毫秒
                        .append(Long.toString(keyAggrKCTime/* / 1000000*/)).append(",")// 转换为毫秒
