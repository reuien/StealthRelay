...
public class DOKeyStore {
    ...
    private DOKeyStore(java.security.KeyStore ks, String path, char[] pwdArray) {
        this.keyStore = ks;
    ...
    public static DOKeyStore localKeystoreFromFile(String path, char[] pwdArray) throws IOException,
        ...
        return new DOKeyStore(ks, path, pwdArray);
    }

    public static DOKeyStore createLocalKeystore(String path, char[] pwdArray) throws KeyStoreException,
